...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }) {
  return {
    title: locale === "es"
      ? "Hoteles baratos en México - Compara Booking, Expedia, Hotels.com"
      : "Cheap hotels in Mexico - Compare Booking, Expedia, Hotels.com",
    description: locale === "es"
      ? "Compara precios de hoteles en Cancún, CDMX, Playa del Carmen, Puerto Vallarta, Los Cabos y más destinos en México."
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-arena-500 text-lg max-w-2xl mx-auto">
            {locale === "es"
              ? "Compara precios de Booking.com, Expedia, Hotels.com y más sitios para encontrar la mejor oferta"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-arena-500">
                {locale === "es"
                  ? "Selecciona la ciudad y fechas. Comparamos más de 2 millones de hoteles."
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-arena-500">
                {locale === "es"
                  ? "Ve el mismo hotel en Booking, Expedia y más sitios. El precio puede variar hasta 40%."
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-semibold text-arena-900 text-sm">
                {locale === "es" ? "¿Qué sitios comparan?" : "What sites do you compare?"}
              </h3>
              <p className="text-sm text-arena-500 mt-1">
                {locale === "es"
                  ? "Comparamos Booking.com, Expedia, Hotels.com, Agoda, Hoteles.com, Trip.com y más de 70 sitios de reserva de hoteles."
                  : "We compare Booking.com, Expedia, Hotels.com, Agoda, Hoteles.com, Trip.com and over 70 hotel booking sites."}
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-arena-900 text-sm">
                {locale === "es" ? "¿Cuánto cuesta un hotel en México?" : "How much does a hotel cost in Mexico?"}
              </h3>
              <p className="text-sm text-arena-500 mt-1">
                {locale === "es"
                  ? "Varía por destino. Ciudades: $600-2,000 MXN/noche. Playas: $1,000-5,000 MXN/noche. All-inclusive: $2,500-8,000 MXN/noche por persona."
