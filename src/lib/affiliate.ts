...
export const AFFILIATE_CONFIG = {
  ...
  travelpayouts: {
    // Marker 511361 belongs to the Rutasmexico project in Travelpayouts.
    // The previous marker (510654) was for an unrelated project
    // (Paginaweb-ruddy), which meant every affiliate click generated by
    // this site was being credited there instead of here.
    marker: "511361",
    enabled: true,
  },
